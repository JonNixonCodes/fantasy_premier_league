...
def fantasy_premierleague_api_elementsummary_day(request):
    """HTTP Cloud Function.
    Args:
    ...
    for element_id in element_ids:
        ...
        # Load data to GCS
        destination_blob_name = "landing/fantasy_premierleague_api_elementsummary/{}_{}.json".format(str(element_id),source_date.strftime("%Y%m%d"))
