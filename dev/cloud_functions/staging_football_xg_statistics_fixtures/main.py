...
def event_handler(cloud_event):
    ...
    # Check if updated blob is in folder:football_xg_statistics_fixtures
    if re.search("football_xg_statistics_fixtures", blob_name)==None:
        return 'OK'
    ...
    # Export fixtures
    fixtures_blob_name = f"football_xg_statistics_fixtures/source_date={source_date_str}/data00.jsonl"
