...
def event_handler(cloud_event):
    ...
    # Check if updated blob is in folder:fantasy_premierleague_api_fixtures
    if re.search("fantasy_premierleague_api_fixtures", blob_name)==None:
        return 'OK'
    ...
    # Export fixtures
    fixtures_blob_name = f"fantasy_premierleague_api_fixtures/source_date={source_date_str}/data00.jsonl"
    fixtures = blob_data["data"]
